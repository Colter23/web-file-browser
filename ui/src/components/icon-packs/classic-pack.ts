...
const classicSymbolIcons: Record<string, string> = {
  ...
  "action.appearance": "icon-setting-filling",
  ...
  "action.favorite": "icon-folder-fill",
  "action.favorite-filled": "icon-folder-open-fill",
  "action.warning": "icon-setting",
  ...
  "action.player-large": "icon-viewgrid",
  "action.player-small": "icon-view-list",
  "action.player-mini": "icon-listview",
  ...
  "playback.shuffle": "icon-viewgrid",
  ...
  "view.audio": "icon-file-fill",
  "view.playlist": "icon-listview",
